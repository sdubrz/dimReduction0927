...
def mnist_scatter():
    ...
    path = "E:\\文件\\IRC\\特征向量散点图项目\\result2020\\result0119\\datasets\\MNIST50mclass1_526\\"  # XPS
    ...
    if option == 1:  # 直接画散点图
        ...
        mnist_images(path, eta=0.36, y_name="MDS.csv", image_shape=(28, 28), colormap='gray')  # 搜 反转
